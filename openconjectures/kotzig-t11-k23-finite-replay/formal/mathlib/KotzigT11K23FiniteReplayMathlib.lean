namespace KotzigT11K23FiniteReplayMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `kotzig-t11-k23-finite-replay`.
...
end KotzigT11K23FiniteReplayMathlib
