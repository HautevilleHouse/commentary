namespace LawsCouponCounterexampleMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `laws-coupon-counterexample`.
...
end LawsCouponCounterexampleMathlib
