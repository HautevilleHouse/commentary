namespace CrimRectairBoundaryCounterexampleMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `crim-rectair-boundary-counterexample`.
...
end CrimRectairBoundaryCounterexampleMathlib
