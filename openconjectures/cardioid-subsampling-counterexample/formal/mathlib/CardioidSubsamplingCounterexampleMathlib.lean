namespace CardioidSubsamplingCounterexampleMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `cardioid-subsampling-counterexample`.
...
end CardioidSubsamplingCounterexampleMathlib
