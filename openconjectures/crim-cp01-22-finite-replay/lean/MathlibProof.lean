namespace CrimCp0122FiniteReplayMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `crim-cp01-22-finite-replay`.
...
end CrimCp0122FiniteReplayMathlib
