namespace MeshClass69InvolutionCounterexampleMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `mesh-class69-involution-counterexample`.
...
end MeshClass69InvolutionCounterexampleMathlib
