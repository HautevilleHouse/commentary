namespace QcatalanBivariateN6Mathlib

/-! Standalone Lean Lake shelf for the published commentary packet `qcatalan-bivariate-n6`.
...
end QcatalanBivariateN6Mathlib
