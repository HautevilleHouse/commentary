namespace ContinuedFractionGcfK1FiniteReplayMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `continued-fraction-gcf-k1-finite-replay`.
...
end ContinuedFractionGcfK1FiniteReplayMathlib
