namespace PermutationPolynomialQ3FiniteReplayMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `permutation-polynomial-q3-finite-replay`.
...
end PermutationPolynomialQ3FiniteReplayMathlib
