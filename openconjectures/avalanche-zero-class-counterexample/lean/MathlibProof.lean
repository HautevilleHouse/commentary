namespace AvalancheZeroClassCounterexampleMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `avalanche-zero-class-counterexample`.
...
end AvalancheZeroClassCounterexampleMathlib
