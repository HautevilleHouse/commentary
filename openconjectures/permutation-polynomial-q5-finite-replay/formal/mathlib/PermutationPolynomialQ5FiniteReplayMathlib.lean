namespace PermutationPolynomialQ5FiniteReplayMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `permutation-polynomial-q5-finite-replay`.
...
end PermutationPolynomialQ5FiniteReplayMathlib
