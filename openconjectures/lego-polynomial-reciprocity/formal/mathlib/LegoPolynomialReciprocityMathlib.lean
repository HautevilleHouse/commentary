namespace LegoPolynomialReciprocityMathlib

/-! Standalone Lean Lake shelf for the published commentary packet `lego-polynomial-reciprocity`.
...
end LegoPolynomialReciprocityMathlib
